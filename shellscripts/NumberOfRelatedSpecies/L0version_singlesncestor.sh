...
GeneratorL1_constgenes ancester1.gene temp > genout_L1.stk				#Generate L1UTR evidence
...
maketranspose expanded.eg species backwards anc > transpose.eg								#transpose the branch ending AB
